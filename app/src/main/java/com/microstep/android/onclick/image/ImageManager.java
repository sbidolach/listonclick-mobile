package com.microstep.android.onclick.image;
...
public class ImageManager {
	...
	public ImageManager(Context context, long _cacheDuration) {
		...
		mDateFormatter = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss zzz", Locale.ENGLISH);
		...
		if (sdState.equals(android.os.Environment.MEDIA_MOUNTED)) {
			...
			cacheDir = new File(sdDir, "onclick/cache");
		} else {
