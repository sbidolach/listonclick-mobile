...
//  public static final String DEFAULT_NO = "No";
  ...
  public IntentIntegrator(Activity activity) {
    ...
    title = activity.getResources().getString(R.string.zxing_title);
    message = activity.getResources().getString(R.string.zxing_message);
    buttonYes = activity.getResources().getString(R.string.button_shop_yes);
    buttonNo = activity.getResources().getString(R.string.button_shop_no);
