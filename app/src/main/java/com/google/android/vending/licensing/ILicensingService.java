...
public interface ILicensingService extends android.os.IInterface {
	...
	public static abstract class Stub extends android.os.Binder implements
		 ...
		 */
		public static com.google.android.vending.licensing.ILicensingService asInterface(
			...
			return new com.google.android.vending.licensing.ILicensingService.Stub.Proxy(
					obj);
		}
		...
		public boolean onTransact(int code, android.os.Parcel data,
			...
			case TRANSACTION_checkLicense: {
				...
				_arg2 = com.google.android.vending.licensing.ILicenseResultListener.Stub
		...
		private static class Proxy implements
			...
			public void checkLicense(
					...
					com.google.android.vending.licensing.ILicenseResultListener listener)
					throws android.os.RemoteException {
				...
				try {
					...
					_data.writeStrongBinder((((listener != null)) ? (listener
							.asBinder()) : (null)));
					mRemote.transact(Stub.TRANSACTION_checkLicense, _data,
	...
	public void checkLicense(long nonce, java.lang.String packageName,
			com.google.android.vending.licensing.ILicenseResultListener listener)
			throws android.os.RemoteException;
}
