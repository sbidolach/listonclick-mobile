...
public interface ILicenseResultListener extends android.os.IInterface {
	...
	public static abstract class Stub extends android.os.Binder implements
		 ...
		 */
		public static com.google.android.vending.licensing.ILicenseResultListener asInterface(
			...
			return new com.google.android.vending.licensing.ILicenseResultListener.Stub.Proxy(
					obj);
		}
		...
		private static class Proxy implements
			...
			public void verifyLicense(int responseCode,
					java.lang.String signedData, java.lang.String signature)
					throws android.os.RemoteException {
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_verifyLicense, _data,
	...
	public void verifyLicense(int responseCode, java.lang.String signedData,
			java.lang.String signature) throws android.os.RemoteException;
}
